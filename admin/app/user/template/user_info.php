...
<!--		<tr>
		...
		<tr>
		  ...
		  <td><?php echo $rt['p1_info']? "<a href=\"user.php?type=info&id={$rt['p1_info']['user_id']}&goto=list\">{$rt['p1_info']['nickname']}</a>":"无"?></td>
		</tr>
		<tr>
		  <td class="label">二级上家:</td>
		  <td><?php echo $rt['p2_info']? "<a href=\"user.php?type=info&id={$rt['p2_info']['user_id']}&goto=list\">{$rt['p2_info']['nickname']}</a>":"无"?></td>
		</tr>
		<tr>
		  <td class="label">三级上家:</td>
		  <td><?php echo $rt['p3_info']? "<a href=\"user.php?type=info&id={$rt['p3_info']['user_id']}&goto=list\">{$rt['p3_info']['nickname']}</a>":"无"?></td>
		</tr>
		<tr>
