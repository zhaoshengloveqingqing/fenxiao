...
<div id="shopping-list">
	...
	<div class="myaddress">
		<form>
			<p class="title">收货地址<a href="#">添加新地址</a></p>
			<div class="am-form-group">
				<label for="doc-ipt-3" class="am-u-sm-2 am-form-label">收件人：</label>
			...
			<div class="am-form-group">
				<label for="doc-ipt-3" class="am-u-sm-2 am-form-label">所在区域：</label>
				<div class="am-u-sm-10">
					<input type="email" id="doc-ipt-3" placeholder="输入你的电子邮件">
				</div>
			</div>
