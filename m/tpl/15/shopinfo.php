...
<div id="main" style="min-height:300px;margin-bottom:20px;">
	...
	<a href="javascirpt:void(0);" class="shopfav">收藏</a>
...
<p class="gototop">
        ...
        <a href="http://api.map.baidu.com/marker?location=<?php echo trim($rt['s_ld']);?>&title=<?php echo $rt['article_title'];?>&content=<?php echo $rt['content'];?>&output=html" style="display:inline; float:right; background:none"><input type="button" id="cart" class="addcar" value="一键导航" style="cursor:pointer;"></a>
</p>
